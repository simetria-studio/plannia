<aside class="fixed inset-y-0 left-0 z-30 flex w-60 flex-col bg-plannia-navy">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        ...
        <a href="{{ route('students.index', ['tab' => 'alunos']) }}" @class(['plannia-nav-item', 'plannia-nav-item-active' => request()->routeIs('students.*') && request()->get('tab', 'alunos') !== 'turmas'])>
            <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
            Alunos
        </a>

        <a href="{{ route('students.index', ['tab' => 'turmas']) }}" @class(['plannia-nav-item', 'plannia-nav-item-active' => (request()->routeIs('students.index') && request()->get('tab') === 'turmas') || request()->routeIs('turmas.*')])>
            <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
            Cadastro de Turmas
        </a>
        ...
        @if(Auth::user()->isDirecao())
            ...
            <a href="{{ route('schools.edit') }}" @class(['plannia-nav-item', 'plannia-nav-item-active' => request()->routeIs('schools.*') || request()->routeIs('users.*')])>
